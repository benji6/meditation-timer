...
const headerContainerEl = document.querySelector('header div') as HTMLDivElement
const homeButtonEl = document.createElement('button')

homeButtonEl.className = 'header__button'
homeButtonEl.innerHTML = `
  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
class Header {
  ...
  public switchAboutToHome() {
    ...
    headerContainerEl.appendChild(homeButtonEl)
  }

  public switchHomeToAbout() {
    homeButtonEl.remove()
    headerContainerEl.appendChild(aboutButtonEl)
    settingsButtonEl.disabled = false
  }

  public switchHomeToSettings() {
    homeButtonEl.remove()
    headerContainerEl.insertAdjacentElement('afterbegin', settingsButtonEl)
  ...
  public switchSettingsToHome() {
    ...
    headerContainerEl.insertAdjacentElement('afterbegin', homeButtonEl)
  }
